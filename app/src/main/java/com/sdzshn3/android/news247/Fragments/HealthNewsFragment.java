...
import com.sdzshn3.android.news247.ViewModel.HealthViewModel;
...
public class HealthNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        healthViewModel = ViewModelProviders.of(HealthNewsFragment.this).get(HealthViewModel.class);
        healthViewModel.getData().observe(HealthNewsFragment.this, articles -> {
        ...
        weatherViewModel = ViewModelProviders.of(HealthNewsFragment.this).get(WeatherViewModel.class);
        weatherViewModel.getData().observe(HealthNewsFragment.this, weatherModel -> {
    ...
    private void setUpUrl() {
        ...
        uriBuilder.appendQueryParameter(DataHolder.category, DataHolder.health);
