...
import com.sdzshn3.android.news247.ViewModel.EntertainmentViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(() -> {
            ...
            if (Utils.isConnected(mContext)) {
                entertainmentViewModel.refresh();
        ...
        URL = Utils.setUpUrl(mContext, mSearchQuery, progressBar, DataHolder.entertainment);

        Utils.setUpRecyclerView(mContext, newsRecyclerView);
        newsRecyclerView.setAdapter(mAdapter);

        entertainmentViewModel = ViewModelProviders.of(EntertainmentNewsFragment.this).get(EntertainmentViewModel.class);
        entertainmentViewModel.getData().observe(EntertainmentNewsFragment.this, articles -> {
        ...
        weatherViewModel = ViewModelProviders.of(EntertainmentNewsFragment.this).get(WeatherViewModel.class);
        weatherViewModel.getData().observe(EntertainmentNewsFragment.this, weatherModel -> {
        ...
        if (searchView != null) {
            ...
            searchView.setOnQueryTextListener(new androidx.appcompat.widget.SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextSubmit(String query) {
                    mSearchQuery = query;
                    Utils.setUpUrl(mContext, mSearchQuery, progressBar, DataHolder.entertainment);
                    entertainmentViewModel.refresh();
                    return true;
                }
            ...
            searchItem.setOnActionExpandListener(new MenuItem.OnActionExpandListener() {
                ...
                public boolean onMenuItemActionCollapse(MenuItem item) {
                    mSearchQuery = null;
                    Utils.setUpUrl(mContext, null, progressBar, DataHolder.entertainment);
                    entertainmentViewModel.refresh();
                    return true;
                }
            });
