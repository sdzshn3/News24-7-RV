...
import com.sdzshn3.android.news247.SupportClasses.PaginationScrollListener;
...
import static com.sdzshn3.android.news247.SupportClasses.DataHolder.holder;
...
public class NewsFeedFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        loaderManager.initLoader(holder.NEWS_LOADER_ID, null, NewsFeedFragment.this);
        loaderManager.initLoader(holder.WEATHER_LOADER_ID, null, NewsFeedFragment.this);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                loaderManager.restartLoader(holder.NEWS_LOADER_ID, null, NewsFeedFragment.this);
        ...
        newsRecyclerView.addOnScrollListener(new PaginationScrollListener(layoutManager) {
            @Override
    ...
    public Loader<List<News>> onCreateLoader(int id, @Nullable Bundle bundle) {
        ...
        switch (id) {
            case holder.NEWS_LOADER_ID:
                ...
                uriBuilder.appendQueryParameter(holder.pageSize, "10");
    ...
    public void onLoadFinished(@NonNull Loader<List<News>> loader, List<News> newsList) {
        ...
        switch (id) {
            case holder.NEWS_LOADER_ID:
                ...
                loaderManager.destroyLoader(holder.NEWS_LOADER_ID);
                break;
            case holder.WEATHER_LOADER_ID:
                if (newsList != null && !newsList.isEmpty()) {
                    ...
                    gotWeather = true;
                    loaderManager.destroyLoader(holder.WEATHER_LOADER_ID);
                }
        }
        if (!gotWeather) {
            gotWeather = false;
