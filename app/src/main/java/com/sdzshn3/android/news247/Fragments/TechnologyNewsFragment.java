...
public class TechnologyNewsFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                loaderManager.restartLoader(holder.NEWS_LOADER_ID, null, TechnologyNewsFragment.this);
        ...
        loaderManager.initLoader(holder.NEWS_LOADER_ID, null, TechnologyNewsFragment.this);
        loaderManager.initLoader(holder.WEATHER_LOADER_ID, null, TechnologyNewsFragment.this);
