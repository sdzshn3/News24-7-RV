...
public class TopHeadlinesFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        URL = Utils.setUpUrl(mContext, mSearchQuery, progressBar, null);
