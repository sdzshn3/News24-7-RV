...
public class BusinessNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        businessViewModel.getData().observe(BusinessNewsFragment.this, new Observer<List<News>>() {
            @Override
        ...
        weatherViewModel.getData().observe(BusinessNewsFragment.this, new Observer<List<News>>() {
            @Override
            public void onChanged(@Nullable List<News> newsList) {
                if (newsList != null) {
