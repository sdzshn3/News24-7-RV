    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                loaderManager.restartLoader(holder.NEWS_LOADER_ID, null, BusinessNewsFragment.this);
        ...
        loaderManager.initLoader(holder.NEWS_LOADER_ID, null, BusinessNewsFragment.this);
        loaderManager.initLoader(holder.WEATHER_LOADER_ID, null, BusinessNewsFragment.this);
        ...
        switch (id) {
            ...
            case holder.WEATHER_LOADER_ID:
                if (newsList != null && !newsList.isEmpty()) {
                    ...
                    weatherTemp.setText(mContext.getString(R.string.weather_temperature_concatenate, temp));
                    gotWeather = true;
